...
/* package Total-Automaton-0.1.0.0 */
#ifndef VERSION_Total_Automaton
#define VERSION_Total_Automaton "0.1.0.0"
#endif /* VERSION_Total_Automaton */
#ifndef MIN_VERSION_Total_Automaton
#define MIN_VERSION_Total_Automaton(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Total_Automaton */
...
#define CURRENT_COMPONENT_ID "Total-Automaton-0.1.0.0-inplace-Total-Automaton"
